...
/****** Object:  Table [dbo].[CTPhieuDatPhong]    ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CTPhieuThuePhong]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DanhSachQuyen]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PhieuDatPhong]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PhieuThuePhong]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[LienHe] ([id], [hoTen], [sdt], [email], [ngayGui], [tinhTrang]) VALUES (4, N'Hà', N'0334370822', N'hathanh.0113@gmail.com', CAST(N'2025-06-01' AS Date), 0)
SET IDENTITY_INSERT [dbo].[LienHe] OFF
GO
SET IDENTITY_INSERT [dbo].[LienHe] ON
INSERT [dbo].[LienHe] ([id], [hoTen], [sdt], [email], [ngayGui], [tinhTrang]) VALUES (5, N'Trần Thị B', N'0912345678', N'tranthib@gmail.com', CAST(N'2025-07-21' AS Date), 0);
SET IDENTITY_INSERT [dbo].[LienHe] OFF
GO
...
INSERT [dbo].[PhanHoi] ([id], [hoTen], [sdt], [email], [noiDung], [ngayGui], [tinhTrang]) VALUES (1, N'Hà', N'0334370822', N'hathanh.0113@gmail.com', N'Best service', CAST(N'2025-05-31' AS Date), 0)
GO
SET IDENTITY_INSERT [dbo].[PhanHoi] OFF
GO
SET IDENTITY_INSERT [dbo].[PhanHoi] ON
INSERT [dbo].[PhanHoi] ([id], [hoTen], [sdt], [email], [noiDung], [ngayGui], [tinhTrang]) VALUES (2, N'Nguyễn Văn A', N'0987654321', N'vana@gmail.com', N'Phòng sạch sẽ, dịch vụ tốt', CAST(N'2025-07-26' AS Date), 1);
SET IDENTITY_INSERT [dbo].[PhanHoi] OFF
GO
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP202501', N'KH0001', CAST(N'2025-07-20' AS Date), CAST(N'2025-07-25' AS Date), CAST(500000 AS Decimal(18, 0)), 2, 1, N'NV0001');
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP0001', N'KH0001', CAST(N'2025-03-17' AS Date), CAST(N'2025-03-25' AS Date), CAST(300000 AS Decimal(18, 0)), 1, 1, N'NV0001')
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP0002', N'KH0002', CAST(N'2025-04-22' AS Date), CAST(N'2025-05-25' AS Date), CAST(600000 AS Decimal(18, 0)), 3, 0, N'NV0002')
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP0003', N'KH0003', CAST(N'2025-05-17' AS Date), CAST(N'2025-07-30' AS Date), CAST(300000 AS Decimal(18, 0)), 3, 1, N'NV0001')
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP0004', N'KH0004', CAST(N'2025-11-01' AS Date), CAST(N'2025-12-25' AS Date), CAST(600000 AS Decimal(18, 0)), 4, 1, N'NV0002')
INSERT [dbo].[PhieuDatPhong] ([maPDP], [maKH], [ngayDen], [ngayDi], [tongTienCoc], [soNguoi], [tinhTrang], [maNV]) VALUES (N'PDP0005', N'KH0007', CAST(N'2025-11-11' AS Date), CAST(N'2025-11-29' AS Date), CAST(300000 AS Decimal(18, 0)), 2, 0, N'NV0002')
GO
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP202501', N'PDP202501', N'KH0001', N'NV0001', CAST(N'2025-07-20' AS Date), CAST(N'2025-07-25' AS Date));
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP0001', N'PDP0001', N'KH0001', N'NV0001', CAST(N'2025-03-19' AS Date), CAST(N'2025-03-25' AS Date))
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP0002', N'PDP0002', N'KH0002', N'NV0002', CAST(N'2025-04-22' AS Date), CAST(N'2025-05-25' AS Date))
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP0003', N'PDP0003', N'KH0003', N'NV0001', CAST(N'2025-05-17' AS Date), CAST(N'2025-07-27' AS Date))
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP0004', N'PDP0004', N'KH0004', N'NV0001', CAST(N'2025-11-10' AS Date), CAST(N'2025-12-21' AS Date))
INSERT [dbo].[PhieuThuePhong] ([maPTP], [maPDP], [maKH], [maNV], [ngayThue], [ngayTra]) VALUES (N'PTP0005', N'PDP0005', N'KH0005', N'NV0002', CAST(N'2025-11-11' AS Date), CAST(N'2025-11-29' AS Date))
GO
...
GO
/****** Object:  StoredProcedure [dbo].[KhachHang_TimKiem]    ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
